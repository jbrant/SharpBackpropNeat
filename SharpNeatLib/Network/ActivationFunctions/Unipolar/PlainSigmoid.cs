...
namespace SharpNeat.Network
{
    ...
    public class PlainSigmoid : IActivationFunction
    {
        ...
        /// </summary>
        public static readonly IActivationFunction __DefaultInstance = new PlainSigmoid();
        ...
        /// <summary>
        /// Calculates the partial derivative of the sigmoid activation function with respect to x (the output).
        /// </summary>
